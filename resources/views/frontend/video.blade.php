        ...
        <nav class="flex mb-10" aria-label="Breadcrumb">
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
              <a href="/portfolio" class="inline-flex items-center text-sm text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="/galeri" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Galeri</a>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <div class="justify-center row">
          <div class="w-full lg:w-2/3">
            <div class="pb-8 text-center section-title">
              ...
              <span class="mt-4"><a href="/gallery" class="text-blue-500 btn">Foto</a> | <a href="/gallery/videos" class="text-blue-700 font-bold ">Video</a> </span>
            </div>
           ...
           <div class="w-full sm:w-2/3 lg:w-1/3">
            ...
            >
              ...
              <div class="p-8">
                ...
                <p>{{ $gallery->title }}</p>
                <a href="{{$gallery->link}}">{{$gallery->link}}</a>
              </div>
            </div>
